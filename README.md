# Hello AdventAI - Day 3️⃣

![Banner](repository-assets/banner.png)

[![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d3&owner=%40me&name=th-adventai-d3&description=AdventAI+Day+3+Fork&visibility=public)

## Table of Contents

- [Hello AdventAI - Day 3️⃣](#hello-adventai---day-3️⃣)
...
![Screengrab](repository-assets/news_screen.gif)

On Day 3️⃣, we are unwrapping an advanced AI-powered news aggregation and personalization app designed to cut through the information overload and deliver precisely targeted, meaningful news insights directly to your inbox.

News Digest brings you:

- **Personalized News Curation**: Uses user recommendations and AI to understand your interests, reading preferences, and information needs.
- **AI-Powered Curation**: Leverages sophisticated artificial intelligence to filter, prioritize, and summarize the most relevant and impactful news pieces.
- **Multi-Source Intelligence**: Aggregates news from diverse global sources, ensuring comprehensive and balanced reporting.
- **Daily Intelligent Digest**: Delivers a carefully crafted email newsletter with top stories, in-depth analysis, and contextual insights.
- **Custom Topic Tracking**: Create personalized news feeds for specific interests, industries, or global regions.

> [!NOTE]
> This app requires the `send_email`, `memory_fetch`, `memory_store`, `image_generation_flux` and `newswire` tools.
...
- [![Fork](https://img.shields.io/badge/CLONE%20THIS%20REPO-0088FF?style=for-the-badge)](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d3&owner=%40me&name=th-adventai-d3&description=AdventAI+Day+3+Fork&visibility=public)
  ...
  Or Create a [Fork](https://github.com/new?template_owner=toolhouse-community&template_name=adventai-d3&owner=%40me&name=th-project&description=AdventAI+Day+3+Fork&visibility=public)
...
```bash
git clone https://github.com/{USERNAME}/adventai-d3/
cd adventai-d3
```
...
[Back to Top ⬆️](#hello-adventai---day-3️⃣)